...
fn test_msg_id_fields() {
    ...
    let field = output.into_iter().next().unwrap();
    let children = field.children().collect::<Vec<_>>();
    assert_eq!(format!("{children:?}"), "[msg_id { text: \" <sadqf54d@test.com>\", children: [dot_atom_text { text: \"sadqf54d\", children: [atext_seq { text: \"sadqf54d\" }] }, dot_atom_text { text: \"test.com\", children: [atext_seq { text: \"test\" }, atext_seq { text: \"com\" }] }] }]");
    ...
    let field = output.into_iter().next().unwrap();
    let children = field.children().collect::<Vec<_>>();
    assert_eq!(format!("{children:?}"), "[msg_id { text: \" <sqdfsf@test.com> \", children: [dot_atom_text { text: \"sqdfsf\", children: [atext_seq { text: \"sqdfsf\" }] }, dot_atom_text { text: \"test.com\", children: [atext_seq { text: \"test\" }, atext_seq { text: \"com\" }] }] }, msg_id { text: \"<47@[127.0.0.1]>\", children: [dot_atom_text { text: \"47\", children: [atext_seq { text: \"47\" }] }, no_fold_literal { text: \"[127.0.0.1]\" }] }]");
